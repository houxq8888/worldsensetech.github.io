...
上一篇[从零搭建世界模型实验环境](world-model-lab-setup.html)，我们跑通了 DreamerV3。有读者问：训练好的世界模型能做什么？
...
如果你已经跑通了 DreamerV3（参考[上一篇教程](world-model-lab-setup.html)），可以试试以下步骤生成合成数据：
...
实践出真知。代码和更多资源会持续更新在 [GitHub](https://github.com/houxq8888/worldsensetech.github.io)。
