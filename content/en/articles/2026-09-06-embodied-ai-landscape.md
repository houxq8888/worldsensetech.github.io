...
**Representatives:** DreamerV3 (RSSM + imagination), TD-MPC2 (latent dynamics + MPC), and more broadly world foundation models (such as NVIDIA Cosmos)
...
Marble has the potential to become an important environment generation component in the sim-to-real chain — addressing the diversity and realism of simulation environments. But it is not itself a robot policy system — rather, it provides spatial intelligence infrastructure for downstream Policy and Dynamics layers.
