...
I've been getting this question a lot lately. Based on what I've observed in the industry and shifts in the hiring market, here are some practical thoughts.
...
- Big-tech AI Labs (DeepMind, OpenAI, Meta, ByteDance, Tencent): continuously hiring, but the bar is extremely high — top-tier conference papers plus a PhD from a prestigious school are basically required.
- Humanoid robotics companies (Unitree, Zhiyuan, Fourier, etc.): aggressively expanded hiring in 2024–2025, but started tightening in 2026 with a stronger emphasis on real-world deployment ability.
- Autonomous driving companies (Waymo, XPeng, Huawei): the planning and decision-making modules need RL backgrounds; demand is stable.


Salary ranges (2026, China, for reference only):


- Fresh PhD graduate: roughly ¥400K–800K/year (big-tech SP offers can reach ¥1M+, but spots are very limited)
- 3–5 years of experience: roughly ¥600K–1.2M/year (varies widely by company, region, and individual ability)
- Senior / expert: ¥1.5M+ (these positions are extremely scarce)
...
- Real-time control: policy inference latency must stay under 10 ms
- Hardware integration: sensor calibration, actuator drivers, communication protocols
- System optimization: CUDA acceleration, model compression, edge deployment
- Simulation platforms: building and maintaining large-scale parallel simulation environments
...
- 3–5 years of experience: roughly ¥500K–900K/year (varies widely by company, region, and individual ability)
- Senior engineer: roughly ¥800K–1.5M/year (senior positions are limited)
...
- Robotics Application Engineer: responsible for task adaptation and deployment in specific scenarios
- Sim-to-Real Engineer: transferring policies trained in simulation onto real robots
- Technical Solutions Engineer: interfacing with customer requirements and designing technical solutions
...
- 3–5 years of experience: roughly ¥400K–700K/year (varies widely by company, region, and individual ability)
- Senior / management: roughly ¥700K–1.2M/year (these positions are relatively scarce)
...
2. Cross-disciplinary talent is the most sought-after.
...
3. Startup opportunities are at the application layer.
...
4. Geographic concentration is pronounced.
